...
public class MemberEndpoint
{
   ...
   {
      TypedQuery<Member> findByIdQuery = em.createQuery("SELECT DISTINCT m FROM Member m LEFT JOIN FETCH m.invitedBy WHERE m.id = :entityId ORDER BY m.id", Member.class);
   ...
   {
      TypedQuery<Member> findAllQuery = em.createQuery("SELECT DISTINCT m FROM Member m LEFT JOIN FETCH m.invitedBy ORDER BY m.id", Member.class);
